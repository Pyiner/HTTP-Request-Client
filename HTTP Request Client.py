...
class MyFrame2 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = 'Http Request Client' pos = wx.DefaultPosition, size = wx.Size( 554,430 ), style =wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL )
